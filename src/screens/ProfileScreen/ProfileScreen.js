...
export default function ProfileScreen(props) {
    ...
    const setDailyTrainingData = async () => {
        let id = "";
        const date = new Date();
                        ...
                        <List.Section>
                            ...
                            <List.Accordion
                                ...
                                <FormControl isRequired backgroundColor={'#fff'}
                                             isInvalid={!allValues.age || allValues.age < 1 || allValues.age > 120}>
                                    <Stack mx={2}>
                                ...
                                <FormControl isRequired backgroundColor={'#fff'}
                                             isInvalid={!(allValues.height + "") || allValues.height < 50 || allValues.height > 220}>
                                    <Stack mx={2}>
                                ...
                                <FormControl isRequired backgroundColor={'#fff'}
                                             isInvalid={!(allValues.weight + "") || allValues.weight < 10 || allValues.weight > 500}>
                                    <Stack mx={2}>
                            ...
                            <List.Accordion
                                ...
                                <FormControl isRequired backgroundColor={'#fff'}
                                             isInvalid={!(allValues.dailyGoalCalories + "")}>
                                    <Stack mx={2}>
                                ...
                                <FormControl isRequired backgroundColor={'#fff'}
                                             isInvalid={!(allValues.dailyGoalDistance + "")}>
                                    <Stack mx={2}>
                                ...
                                <FormControl isRequired backgroundColor={'#fff'}
                                             isInvalid={!(allValues.dailyGoalSteps + "")}>
                                    <Stack mx={2}>
